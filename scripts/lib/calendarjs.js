...
function calendarJs( id, options, startDateTime ) {
    ...
    function buildEventEditingDialog() {
        ...
        textFrom.innerText = _options.fromText.replace( ":", "" ) + ":";
        ...
        // textTo.innerText = _options.toText.replace( ":", "" );
        // toSplitContainer.insertAdjacentHTML('beforebegin', '<p>Término:</p>');
        ...
        _element_EventEditorDialog_DateTo.remove();

        _element_EventEditorDialog_TimeTo.remove();
    ...
    function setTranslationStringOptions() {
        if ( !isDefined( _options.previousMonthTooltipText ) ) {
            _options.previousMonthTooltipText = "Mês anterior";
        }

        if ( !isDefined( _options.nextMonthTooltipText ) ) {
            _options.nextMonthTooltipText = "Próximo mês";
        }

        if ( !isDefined( _options.previousDayTooltipText ) ) {
            _options.previousDayTooltipText = "Dia anterior";
        }

        if ( !isDefined( _options.nextDayTooltipText ) ) {
            _options.nextDayTooltipText = "Próximo dia";
        }

        if ( !isDefined( _options.previousWeekTooltipText ) ) {
            _options.previousWeekTooltipText = "Semana anterior";
        }

        if ( !isDefined( _options.nextWeekTooltipText ) ) {
            _options.nextWeekTooltipText = "Próxima semana";
        }

        if ( !isDefined( _options.addEventTooltipText ) ) {
            _options.addEventTooltipText = "Adicionar consulta";
        }

        if ( !isDefined( _options.closeTooltipText ) ) {
            _options.closeTooltipText = "Fechar";
        }

        if ( !isDefined( _options.exportEventsTooltipText ) ) {
            _options.exportEventsTooltipText = "Exportar consultas";
        }

        if ( !isDefined( _options.todayTooltipText ) ) {
            _options.todayTooltipText = "Hoje";
        }

        if ( !isDefined( _options.refreshTooltipText ) ) {
            _options.refreshTooltipText = "Atualizar";
        }

        if ( !isDefined( _options.searchTooltipText ) ) {
            _options.searchTooltipText = "Procurar";
        }

        if ( !isDefined( _options.expandDayTooltipText ) ) {
            _options.expandDayTooltipText = "Expandir dia";
        }

        if ( !isDefined( _options.listAllEventsTooltipText ) ) {
            _options.listAllEventsTooltipText = "Ver todas as consultas";
        }
        ...
        if ( !isDefined( _options.fromText ) ) {
            _options.fromText = "Início:";
        }

        if ( !isDefined( _options.toText ) ) {
            _options.toText = "Término:";
        }

        if ( !isDefined( _options.isAllDayText ) ) {
            _options.isAllDayText = "Dia todo";
        }

        if ( !isDefined( _options.titleText ) ) {
            _options.titleText = "Paciente:";
        }

        if ( !isDefined( _options.descriptionText ) ) {
            _options.descriptionText = "Descrição:";
        }

        if ( !isDefined( _options.locationText ) ) {
            _options.locationText = "Consultório:";
        }

        if ( !isDefined( _options.addText ) ) {
            _options.addText = "Adicionar";
        }

        if ( !isDefined( _options.updateText ) ) {
            _options.updateText = "Atualizar";
        }
        ...
        if ( !isDefined( _options.removeEventText ) ) {
            _options.removeEventText = "Remover";
        }

        if ( !isDefined( _options.addEventTitle ) ) {
            _options.addEventTitle = "Adicionar Consulta";
        }

        if ( !isDefined( _options.editEventTitle ) ) {
            _options.editEventTitle = "Editar Consulta";
        }
        ...
        if ( !isDefined( _options.fromTimeErrorMessage ) ) {
            _options.fromTimeErrorMessage = "Por favor, selecione uma data válida.";
        }
        ...
        if ( !isDefined( _options.titleErrorMessage ) ) {
            _options.titleErrorMessage = "Por favor, digite o nome do paciente.";
        }
        ...
        if ( !isDefined( _options.allDayText ) ) {
            _options.allDayText = "Dia todo";
        }

        if ( !isDefined( _options.allEventsText ) ) {
            _options.allEventsText = "Todas Consultas";
        }
        ...
        if ( !isDefined( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Confirmação de remoção";
        }
        
        if ( !isDefined( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventRemoveMessage = "Deseja realmente remover esta consulta?";
        }
        ...
        if ( !isDefined( _options.selectExportTypeTitle ) ) {
            _options.selectExportTypeTitle = "Seletor de tipo de exportação";
        }
        
        if ( !isDefined( _options.selectColorsText ) ) {
            _options.selectColorsText = "Seletor de cores";
        }
        
        if ( !isDefined( _options.backgroundColorText ) ) {
            _options.backgroundColorText = "Cor do fundo:";
        }
        
        if ( !isDefined( _options.textColorText ) ) {
            _options.textColorText = "Cor do texto:";
        }
        
        if ( !isDefined( _options.borderColorText ) ) {
            _options.borderColorText = "Cor da borda:";
        }
        
        if ( !isDefined( _options.searchEventsTitle ) ) {
            _options.searchEventsTitle = "Procurar consultas";
        }
        
        if ( !isDefined( _options.forText ) ) {
            _options.forText = "Para:";
        }
        
        if ( !isDefined( _options.previousText ) ) {
            _options.previousText = "Anterior";
        }
        
        if ( !isDefined( _options.nextText ) ) {
            _options.nextText = "Próximo";
        }
        ...
        if ( !isDefined( _options.repeatsText ) ) {
            _options.repeatsText = "Repetições:";
        }
        ...
        if ( !isDefined( _options.daysToExcludeText ) ) {
            _options.daysToExcludeText = "Dias para excluir:";
        }
        ...
        if ( !isDefined( _options.repeatsNever ) ) {
            _options.repeatsNever = "Nunca";
        }
        
        if ( !isDefined( _options.repeatsEveryDayText ) ) {
            _options.repeatsEveryDayText = "Todo dia";
        }
        
        if ( !isDefined( _options.repeatsEveryWeekText ) ) {
            _options.repeatsEveryWeekText = "Toda Semana";
        }
        
        if ( !isDefined( _options.repeatsEveryMonthText ) ) {
            _options.repeatsEveryMonthText = "Todo mês";
        }
        
        if ( !isDefined( _options.repeatsEveryYearText ) ) {
            _options.repeatsEveryYearText = "Todo ano";
        }
        
        if ( !isDefined( _options.repeatOptionsTitle ) ) {
            _options.repeatOptionsTitle = "Opções de repetições";
        }
        
        if ( !isDefined( _options.moreText ) ) {
            _options.moreText = "Mais";
        }
        
        if ( !isDefined( _options.includeText ) ) {
            _options.includeText = "Incluir:";
        }
        ...
        if ( !isDefined( _options.restoreTooltipText ) ) {
            _options.restoreTooltipText = "Restaurar";
        }
        
        if ( !isDefined( _options.removeAllEventsInSeriesText ) ) {
            _options.removeAllEventsInSeriesText = "Confirmar";
        }
        ...
        if ( !isDefined( _options.enableFullScreenTooltipText ) ) {
            _options.enableFullScreenTooltipText = "Modo tela cheia";
        }
        
        if ( !isDefined( _options.disableFullScreenTooltipText ) ) {
            _options.disableFullScreenTooltipText = "Modo Janela";
        }
        ...
        if ( !isDefined( _options.repeatEndsText ) ) {
            _options.repeatEndsText = "Fim da Repetição:";
        }
        
        if ( !isDefined( _options.noEventsAvailableText ) ) {
            _options.noEventsAvailableText = "Sem consultas disponíveis";
        }
        
        if ( !isDefined( _options.viewWeekEventsText ) ) {
            _options.viewWeekEventsText = "Ver consultas da semana";
        }
        
        if ( !isDefined( _options.noEventsAvailableFullText ) ) {
            _options.noEventsAvailableFullText = "Não há consultas disponíveis para mostrar.";
        }
        
        if ( !isDefined( _options.clickText ) ) {
            _options.clickText = "Clique";
        }
        
        if ( !isDefined( _options.hereText ) ) {
            _options.hereText = "aqui";
        }
        
        if ( !isDefined( _options.toAddANewEventText ) ) {
            _options.toAddANewEventText = "para adicionar uma nova consulta.";
        }
        
        if ( !isDefined( _options.weekText ) ) {
            _options.weekText = "Semana";
        }
        
        if ( !isDefined( _options.groupText ) ) {
            _options.groupText = "Médico:";
        }
        
        if ( !isDefined( _options.configurationTooltipText ) ) {
            _options.configurationTooltipText = "Configuração";
        }
        
        if ( !isDefined( _options.configurationTitleText ) ) {
            _options.configurationTitleText = "Configuração";
        }
        
        if ( !isDefined( _options.visibleGroupsText ) ) {
            _options.visibleGroupsText = "Médicos viséveis:";
        }
